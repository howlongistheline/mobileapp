...
#### Clone repository    
```
git clone https://github.com/howlongistheline/mobileapp.git
```

**Note**: if you want to edit things and send a pull request you should _fork_ this project on GitHub first and clone _your_ fork instead of https://github.com/howlongistheline/mobileapp.git.
...
This app is built using react native, expo sdk
check expo docs for more info about expo platform https://docs.expo.io/
...
```
git remote add upstream https://github.com/howlongistheline/mobileapp.git # only needs to be done once
